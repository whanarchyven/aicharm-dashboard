        ...
        <main className="flex justify-center items-center pitch-bg min-h-screen">
            <div className={'max-w-[1920px]'}>
                ...
                >
                    ...
                    <SwiperSlide className={'w-full h-screen flex items-center justify-center'}>
                        <div className={'w-full h-full px-24 py-12 flex flex-col gap-8 items-center relative justify-center'}>
                            {showPop?<div className={'fixed w-screen bg-black bg-opacity-70 flex items-center justify-center h-screen'}>
                                <div className={'w-96 bg-white relative p-8 flex flex-col gap-5 rounded-lg'}>
                                    <p className={'text-black font-roboto text-3xl font-black'}>Send request to join our eco-system!</p>
                                    <input className={'p-2 rounded-lg text-black text-lg outline-none border-[#FF29D0] border-2'} placeholder={'Name'} />
                                    <input className={'p-2 rounded-lg text-black text-lg outline-none border-[#FF29D0] border-2'} placeholder={'E-mail'} />
                                    <input className={'p-2 rounded-lg text-black text-lg outline-none border-[#FF29D0] border-2'} placeholder={'Phone'} />
                                    <input className={'p-2 rounded-lg text-black text-lg outline-none border-[#FF29D0] border-2'} placeholder={'Post'} />
                                    <input className={'p-2 rounded-lg text-black text-lg outline-none border-[#FF29D0] border-2'} placeholder={'Company'} />
                                    <button onClick={()=>{}} className={'p-2 rounded-lg opacity-30 cursor-auto text-white text-lg outline-none bg-[#FF29D0]'}>Send</button>
